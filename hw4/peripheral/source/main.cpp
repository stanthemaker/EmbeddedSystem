...
const static char DEVICE_NAME[] = "J7Stan";
...
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _magneto_uuid(GattService::UUID_MAGNETOMETER_SERVICE),
...
private:
    ...
    void update_sensor_value()
    {
        ...
        _magneto_service.updateMagnetoVal(pDataXYZ[0], pDataXYZ[1], pDataXYZ[2]);
    }
