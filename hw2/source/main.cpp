...
public:
    ...
    void gatherData(){
        ...
        // Concatenate the MAGNETO data
        BSP_MAGNETO_GetXYZ(pDataXYZ);
        snprintf(output + strlen(output), sizeof(output) - strlen(output), "MAGNETO_X = %d\n", pDataXYZ[0]);
        snprintf(output + strlen(output), sizeof(output) - strlen(output), "MAGNETO_Y = %d\n", pDataXYZ[1]);
        snprintf(output + strlen(output), sizeof(output) - strlen(output), "MAGNETO_Z = %d\n", pDataXYZ[2]);

        // Concatenate the GYRO data
        BSP_GYRO_GetXYZ(pGyroDataXYZ);
        snprintf(output + strlen(output), sizeof(output) - strlen(output), "GYRO_X = %.2f\n", pGyroDataXYZ[0]);
        snprintf(output + strlen(output), sizeof(output) - strlen(output), "GYRO_Y = %.2f\n", pGyroDataXYZ[1]);
        snprintf(output + strlen(output), sizeof(output) - strlen(output), "GYRO_Z = %.2f\n", pGyroDataXYZ[2]);
